...
<div class="modal fade" id="exampleModal{{ $data->id }}" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('/admin/update_smell/' . $data->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="smell" class="form-control" required value="{{ $data->smell }}" placeholder="Add Smell">
                    </div>
