                                ...
                                <div class="row p-3">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select" id="active" name="active">
                                            <option value="1" {{ $offer->active == 1 ? 'selected' : '' }}>Active</option>
                                            <option value="0" {{ $offer->active == 0 ? 'selected' : '' }}>Not Active</option>
                                        </select>
                                    </div>
                                                ...
                                                <tbody>
                                                    @forelse ($products as $data)
                                                        <tr class="text-center">
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input checkbox" type="checkbox" name="product_id[]" value="{{ $data->id }}" {{ $offer->all_products == 0 ? 'checked' : '' }}>
