    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Process
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ url('/admin/add_process') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="worden" class="form-control" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="wordar" class="form-control" required>
                    </div>
