            ...
            <form action="{{ url('/admin/update_promo/' . $data->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="promo" class="form-control" value="{{ $data->promo }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="discount" class="form-control" step="any" value="{{ $data->discount }}" required>
                    </div>
