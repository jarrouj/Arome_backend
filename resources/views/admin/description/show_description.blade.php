                    ...
                    <div class="card mb-4">
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <div class="d-flex justify-content-center">
                                    ...
                                    @include('admin.description.add_description')
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                        ...
                                        @forelse ($description as $data)
                                            <tr class="text-center">
                                                ...
                                                <td class="align-middle">
                                                    <a href="{{ url('admin/update_description', $data->id) }}"
                                                ...
                                                <td class="align-middle">
                                                    <a href="{{ url('admin/delete_description', $data->id) }}"
                                ...
                                {{ $description->render('admin.pagination') }}
                            </div>
                        </div>
                    </div>
                </div>
