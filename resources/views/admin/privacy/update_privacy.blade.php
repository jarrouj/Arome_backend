...
<div class="modal fade" id="exampleModal{{ $data->id }}" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('/admin/update_privacy/' . $data->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="text" class="form-control" value="{{ $data->text }}" required>
                    </div>
